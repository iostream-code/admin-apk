...
// dari Framework7 -- disalin apa adanya (API & implementasi) dari
// inventory-apk/src/lib/toast.js supaya kode lama yang dulu memanggil
// `app.toast.create(...)` bisa dipindah tanpa perubahan.
